...
silt = tkinter.Label(raam, text="Score:", font=minu_font)
silt.place(x=175, y=565)
silt1 = tkinter.Label(raam, text="Lives:", font=minu_font)
...
def uuenda():
    ...
    silt2 = tkinter.Label(raam, text=score, font=minu_font)
    silt2.place(x=230, y=565)
    silt3 = tkinter.Label(raam, text=lives, font=minu_font)
