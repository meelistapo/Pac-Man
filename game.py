...
class game:
        ...
        for line in levelfile:
            ...
            for elem in line:
                if elem == "#":
                    ...
                    moving_obj([x*50+25,y*50+25], self.parent, moving_obj.ghost_imgs[7], name='nõlv')
                elif elem == "U":
                    moving_obj([x*50+25,y*50+25], self.parent, moving_obj.ghost_imgs[8], name='pungas')
                # elif elem == "E":
                #     moving_obj([x*50+25,y*50+25], self.parent, moving_obj.ghost_imgs[8], name='paales')
                # elif elem == "A":
                #     moving_obj([x*50+25,y*50+25], self.parent, moving_obj.ghost_imgs[8], name='annamaa')
                # elif elem == "M":
                #     moving_obj([x*50+25,y*50+25], self.parent, moving_obj.ghost_imgs[8], name='palm')
                x += 1
            y += 1
            x = 0
        levelfile.close()
    ...
    def create_help_message(self):
        messagebox.showinfo(message="Pacversity õpetus:\n"
                                    ...
                                    "Mäng - liikumiseks kasuta nooli, vahepausi alustamiseks/lõpetamiseks vajuta 'Space' või 'Enter', 'Esc' viib sind tagasi peamenüüsse.")
