...
moving_obj.ghost_imgs =[PhotoImage(file="media/ghosts/vilo.png"),
                            ...
                            PhotoImage(file="media/ghosts/nõlv.png"),
...
def uuenda():
    if thisgame.state == "game":
        ...
        if moving_obj.pac.coll_name != None:
            thisgame.viimanehoiatus.config(text=ghostmsg[moving_obj.pac.coll_name][randint(0,1)])
            thisgame.turns_to_show_warning = 80
